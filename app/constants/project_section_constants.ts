export const projectItems = [
  ...
  // {
  //   title: "Personal Journal Website",
  //   brief: "A lightweight single-page application built to explore component architecture and state management in React.",
  //   techs: ["React", "JavaScript", "CSS"],
  //   link: "https://github.com/Poorniiii/SLD_hack_team_2",
  // },
  // {
  //   title: "Personal Journal Website",
  //   brief: "A lightweight single-page application built to explore component architecture and state management in React.",
  //   techs: ["React", "JavaScript", "CSS"],
  //   link: "https://github.com/Poorniiii",
  // },
];
